...
import com.example.mykotlinsample.Admin.AdminAdapters.HiddenCateAdapter
...
class Admin_HiddenCategories : AppCompatActivity(), View.OnClickListener {
    ...
    private fun view_inits() {
        var hiddencate_recycle = findViewById<RecyclerView>(R.id.hiddencate_recycle)
        var hidden_cate_back: ImageView = findViewById(R.id.hidden_cate_back)
    ...
    private fun show_datas() {
        ...
        hiddencate_recycle.adapter = CategoryAdapter(applicationContext, hiddencategorylist)

        hiddencate_recycle.addOnItemTouchListener(
            RecyclerItemClickListenr(this, hiddencate_recycle,
