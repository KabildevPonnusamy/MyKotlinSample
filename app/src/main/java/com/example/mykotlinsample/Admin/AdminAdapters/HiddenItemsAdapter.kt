...
class HiddenItemsAdapter (var context: Context, val hiddenitemList: ArrayList<ItemDatasList>): RecyclerView
    .Adapter<HiddenItemsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent?.context).inflate(R.layout.admin_hiddenitems_item, parent, false)
        return ViewHolder(v)
            }

    override fun getItemCount(): Int {
        return hiddenitemList.size
                }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val iList = hiddenitemList[position]
